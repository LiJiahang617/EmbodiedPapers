---
name: stop-slop-zh
description: 消除中文写作里的 AI 痕迹。写或改任何中文长文本时使用，包括论文精读稿、中英混读稿、文献笔记正文、总结、分析、公众号稿。提供禁用词/禁用标点/禁用结构清单、口语化词组库和四层质检流程。
---
...
写论文精读稿、中英混读稿、文献笔记时，先读 references/academic-notes-profile.md，按那里的分层规则执行。学术笔记的骨架由本库根目录的 `AGENTS.md` 规定，本文件的禁用小标题、禁用 bullet、禁用编号三条在那个场景下让位，其余全部生效。

写公众号、行业分析、普通长文时，按本文件原样执行。
